...
<div id="header_wrapper">
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'calidad')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> </a></p>
     <?php if (theme_get_setting('social_links', 'calidad')): ?>
            <div class="social-icons">
             <ul>
              <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'calidad') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
              <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'calidad'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'calidad') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
              <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'calidad'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'calidad') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
             </ul>
            </div>
          <?php endif; ?>
    <div class="clear"></div>
