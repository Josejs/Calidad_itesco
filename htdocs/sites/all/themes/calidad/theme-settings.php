 ...
 *   The form state.
 */
function calidad_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','calidad'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'calidad'),
  ...
  $form['prof_settings']['top_social_link']['twitter_username'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_username', 'calidad'),
  ...
  $form['prof_settings']['top_social_link']['facebook_username'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_username', 'calidad'),
